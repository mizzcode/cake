...
// Baris komentar: membuat function untuk menghitung tagihan awal berdasarkan jumlah pesanan
...
$listLokasi = ['Jakarta', 'Bogor', 'Depok', 'Tangerang', 'Bekasi'];
...
<body>
    <div class="container border">
        ...
        <img src="gambar/logo.jpg" alt="bento-cake">
    ...
    <?php
    //	Kode berikut dieksekusi setelah tombol Pesan ditekan.
    if (isset($_POST['Pesan'])) {
        ...
        if ($dataPesanan['lokasi'] == "Tangerang") {
            $ongkir = 5000;
        } else if ($dataPesanan['lokasi'] == "Bogor") {
            $ongkir = 10000;
        } else {
            $ongkir = 0;
        }
